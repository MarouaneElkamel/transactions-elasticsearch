...
import kaoun.flouci.transactions.config.audit.AuditEventConverter;
import kaoun.flouci.transactions.domain.PersistentAuditEvent;
...
import static kaoun.flouci.transactions.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
